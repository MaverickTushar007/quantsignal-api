...
def generate_signal(symbol: str, include_reasoning: bool = True, bypass_cache: bool = False) -> Optional[dict]:
    ...
    if include_reasoning:
        reasoning = get_reasoning(
            ...
            probability=ml.regime_adjusted_probability if hasattr(ml, "regime_adjusted_probability") and ml.regime_adjusted_probability else ml.probability,
